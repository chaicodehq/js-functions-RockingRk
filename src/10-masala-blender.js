...
export function pipe(...fns) {
  ...
  return function (data) {
    let result = fns.reduce((result, fn) => fn(result), data);
    return result;
  };
}
...
export function compose(...fns) {
  ...
  return function (data) {
    let result = fns.reduceRight((result, fn) => fn(result), data);
    return result;
  };
}
...
export function createRecipe(steps) {
  ...
  if  (step==="grind") stepsArr.push(grind) 
  if  (step==="roast") stepsArr.push(roast) 
  if  (step==="mix") stepsArr.push(mix) 
  if  (step==="pack") stepsArr.push(pack) 
    
  }

  return pipe(...stepsArr)
}
